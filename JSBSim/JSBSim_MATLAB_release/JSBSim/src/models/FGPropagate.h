...
public:
  ...
  */
  ...
  double GetUVWdot2(int idx) const { return last_vUVWdot(idx); }
  double GetUVWdot3(int idx) const { return last2_vUVWdot(idx); }
  ...
  */
  ...
  double GetQtrndot(int index) const { return vQtrndot(index); }
  double GetLocationdot(int index) const { return vLocationDot(index); }
